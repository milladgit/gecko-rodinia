...
#pragma gecko region exec_pol(exec_policy_chosen) variable_list(h_updating_graph_mask,h_graph_mask,h_graph_visited) independent gang vector
	for( unsigned int i = 0; i < no_of_nodes; i++)
	{
...
#pragma gecko region exec_pol("any") variable_list(h_graph_mask,h_graph_visited) independent gang(1) vector(1)
	for(int i=0;i<1;i++)
	{
...
#pragma gecko region exec_pol(exec_policy_chosen) variable_list(h_cost) independent gang vector
...
#pragma gecko region exec_pol(exec_policy_chosen) variable_list(h_graph_mask,h_graph_nodes,h_graph_edges,h_graph_visited,h_cost,h_updating_graph_mask) independent gang vector
...
#pragma gecko region exec_pol(exec_policy_chosen) variable_list(h_graph_mask,h_graph_visited,h_cost,h_updating_graph_mask) independent gang vector reduction(||:stop)
  		for(int tid=0; tid< no_of_nodes ; tid++ )
		{
...
#pragma gecko memory free(h_graph_nodes, h_graph_edges, h_graph_mask, h_updating_graph_mask, h_graph_visited, h_cost)
