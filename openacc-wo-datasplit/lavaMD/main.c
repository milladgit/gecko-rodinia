...
//	box_cpu = (box_str*)malloc(dim_cpu.box_mem);
    geckoMemoryDeclare((void**)&box_cpu, sizeof(box_str), dim_cpu.number_boxes, exec_loc, GECKO_DISTANCE_NOT_SET);
...
//	rv_cpu = (FOUR_VECTOR*)malloc(dim_cpu.space_mem);
    geckoMemoryDeclare((void**)&rv_cpu, sizeof(FOUR_VECTOR), dim_cpu.space_elem, exec_loc, GECKO_DISTANCE_NOT_SET);
...
//	qv_cpu = (fp*)malloc(dim_cpu.space_mem2);
    geckoMemoryDeclare((void**)&qv_cpu, sizeof(fp), dim_cpu.space_elem, exec_loc, GECKO_DISTANCE_NOT_SET);
    for(i=0; i<dim_cpu.space_elem; i=i+1) {
...
//	fv_cpu = (FOUR_VECTOR*)malloc(dim_cpu.space_mem);
    geckoMemoryDeclare((void**)&fv_cpu, sizeof(FOUR_VECTOR), dim_cpu.space_elem, exec_loc, GECKO_DISTANCE_NOT_SET);
    for(i=0; i<dim_cpu.space_elem; i=i+1) {
