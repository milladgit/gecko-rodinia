...
#pragma gecko memory allocate(m2[0:matrix_dim*matrix_dim]) type(float) location(exec_loc)
  ...
  // #pragma gecko memory register(v_addr[0:100]) type(double) loc("LocN")
    ...
    #pragma gecko memory register(m2[0:matrix_dim*matrix_dim]) type(float) loc("LocN")
    #pragma gecko memory allocate(m[0:matrix_dim*matrix_dim]) type(float) location(exec_loc)
    #pragma gecko memory copy from(m2[0:matrix_dim*matrix_dim]) to(m[0:matrix_dim*matrix_dim])
