...
#pragma gecko region exec_pol(exec_policy_chosen) variable_list(input_itemsets) independent gang vector
...
#pragma gecko memory free(referrence,input_itemsets,output_itemsets)
